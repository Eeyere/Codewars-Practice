# -*- coding: utf-8 -*-
"""
Created on Wed Aug 24 10:54:48 2022
...
This algorithm serves well its educative purpose but it's tremendously 
...
number over 50 is simply too much. You may go for a cup of coffee or go 
take a nap while you wait for the answer. But if you try it here in Code 
Wars you will most likely get a code timeout before any answers.
...
algorithm while still keeping it sufficiently optimized to get an answer 
very rapidly.
...
calculate it and put it in the cache, otherwise we returned the cached 
number.
